...
public class GameManager : MonoBehaviour
{
    ...
    public event UnityAction WoodChangeAct = null;
    public event UnityAction StoneChangeAct;
    public event UnityAction IronChangeAct;
    public event UnityAction GoldChangeAct;
    public event UnityAction ExpChangeAct;
    ...
    void Start()
    {
        ...
        WoodChangeAct += () => playerUI.ChangeWoodText(myWood);
