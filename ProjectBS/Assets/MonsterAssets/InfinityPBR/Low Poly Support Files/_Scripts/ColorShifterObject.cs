...
namespace InfinityPBR
{
    ...
    public class ColorShifterColorItem : IComparable<ColorShifterColorItem>
    {
        ...
        [NonSerialized]public List<int> children = new List<int>();
        [NonSerialized] public List<ColorShifterColorItem> colorItemChildren = new List<ColorShifterColorItem>();
        [NonSerialized] public bool isChild = false;
        [NonSerialized] public int parentIndex = 0;
        [NonSerialized] public string parentName;
        [NonSerialized] public float childHueShift = 0f;
        [NonSerialized] public float childSaturationShift = 0f;
        [NonSerialized] public float childValueShift = 0f;
